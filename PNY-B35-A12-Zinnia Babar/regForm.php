...
<html lang="en">
  ...
  <form method="GET" action="saveReg.php">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="text" name="t2" class="form-control" id="inputPassword3">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="text" name="t3" class="form-control" id="inputPassword3">
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="email" name="t5" class="form-control" id="inputPassword3">
    </div>
  </div>
